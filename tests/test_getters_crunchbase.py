...
def mock_s3_env(aws_credentials):
    ...
    with mock_s3():
        ...
        base_file_names = ["acquisitions", "category_groups", "checksum", "degrees", "event_appearances", "events", "funding_rounds", "funds", "investment_partners", "investments", "investors", "ipos", "jobs", "org_parents", "organization_descriptions", "organizations", "people_descriptions", "people"]
